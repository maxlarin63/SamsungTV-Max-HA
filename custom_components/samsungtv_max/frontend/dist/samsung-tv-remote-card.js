...
`;window.customCards=window.customCards||[],window.customCards.push({type:"samsung-tv-remote-card",name:"Samsung TV Remote",description:"Full remote control for Samsung Tizen TVs (Samsung TV Max)"});const ut=[{key:"_POWER",icon:"mdi:power",label:"ON"},{key:"KEY_MENU",icon:"mdi:menu",label:"Menu"}],_t=[{key:"KEY_VOLUP",icon:"mdi:volume-plus",label:"Vol +",hold:!0},{key:"KEY_MUTE",icon:"mdi:volume-off",label:"Mute"},{key:"KEY_CHUP",icon:"mdi:arrow-up-bold",label:"CH up",hold:!0}],mt=[{key:"KEY_VOLDOWN",icon:"mdi:volume-minus",label:"Vol −",hold:!0},{key:"KEY_SOURCE",icon:"mdi:video-input-hdmi",label:"Source"},{key:"KEY_CHDOWN",icon:"mdi:arrow-down-bold",label:"CH dn",hold:!0}],ft=[{key:"KEY_HOME",icon:"mdi:home",label:"Home"},{key:"KEY_UP",icon:"mdi:arrow-up",hold:!0},{key:"KEY_INFO",icon:"mdi:information",label:"Info"}],$t=[{key:"KEY_LEFT",icon:"mdi:arrow-left",hold:!0},{key:"KEY_ENTER",icon:"mdi:keyboard-return",label:"OK"},{key:"KEY_RIGHT",icon:"mdi:arrow-right",hold:!0}],yt=[{key:"KEY_RETURN",icon:"mdi:keyboard-backspace",label:"Back"},{key:"KEY_DOWN",icon:"mdi:arrow-down",hold:!0},{key:"KEY_EXIT",icon:"mdi:close",label:"Exit"}],gt=[{service:"media_play",icon:"mdi:play",label:"Play"},{service:"media_pause",icon:"mdi:pause",label:"Pause"},{service:"media_stop",icon:"mdi:stop",label:"Stop"},{service:"media_previous_track",icon:"mdi:skip-previous",label:"Prev"},{service:"media_next_track",icon:"mdi:skip-next",label:"Next"}],vt=[{name:"YouTube",icon:"mdi:youtube",label:"YT"},{name:"Netflix",icon:"mdi:netflix",label:"Netflix"},{name:"Spotify",icon:"mdi:spotify",label:"Spotify"},{name:"Browser",icon:"mdi:earth",label:"Web"}];let bt=class extends ot{constructor(){super(...arguments),this.connectedWhileHidden=!0,this._textValue=""}setConfig(t){if(!t.entity)throw new Error("entity is required");this._config=t}getCardSize(){return 8}updated(t){if(super.updated(t),t.has("hass")&&this.hass&&this._config){const t=this.hass.states[this._config.entity];if(t){t.attributes.keyboard_active&&this._textValue}}}firstUpdated(){this._bindHoldButtons()}render(){if(!this._config)return D``;if(!this.hass)return D`<ha-card><div class="status">Loading…</div></ha-card>`;const t=this.hass.states[this._config.entity];if(!t)return D`<ha-card><div class="status">Entity not found: ${this._config.entity}</div></ha-card>`;const e=t.attributes,i="on"===t.state;return D`
      <ha-card>
